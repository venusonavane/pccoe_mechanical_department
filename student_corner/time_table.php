...
<br><br>
    ...
    <div class="container-fluid title"><span>Time Table</span></div>
    <div class="pt-4">
        <ul class="fa-ul">
            <!-- <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank" href="">F.E - B. Tech Mechanical Engineering</a></li>
            <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank" href="">S.E - B. Tech Mechanical Engineering</a></li> -->
