          ...
          <div class="container-fluid content-panel">
            ...
            <div class="row bg-white mx-lg-5 mx-md-3 mx-sm-1 mt-3 rounded">
              <div class="col-sm-3 p-2 text-center align-self-center container-fluid">
                <img src="facultyphoto/SSLakade.jpg" class="card-img" style="height: 150px; width: 150px;" alt="Faculty Image">
                <br />
                <button class="website btn btn-primary mt-3">
                  <a href="https://sanjaylakade.com/" target="_blank"><span
              ...
              <div class="col-sm-9 align-self-center pt-3">
                ...
                <div>
                  <dl class="row">
                    ...
                    <dd class="col-sm-9 col-8">Ph.D.</dd>
                    ...
                    <span class="align-self-center text-muted">
                      Email&nbsp;:&nbsp;<a
                        href="mailto: sanjay.lakade@pccoepune.org ">sanjay.lakade@pccoepune.org </a> |
                      Contact&nbsp;:&nbsp;<a href="tel: +919325213417">9325213417</a>
                      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                      <div class="profile mt-1">
                        <button class="btn btn-primary btn-sm ">
                          <a href="https://scholar.google.co.in/citations?user=cd6o4Y0AAAAJ&hl=en&oi=sra"
                        class="text-white btn btn-sm btn-primary">
                        Google scholar profile</a>
                        </button>
                        <button class="btn btn-sm btn-primary ">
                          <a href="https://www.scopus.com/authid/detail.uri?authorId=55180509700"
                        class="text-white btn btn-sm btn-primary">
                        Scopus Profile</a>
                        </button>
                        <button class="btn btn-sm btn-primary ">
                          <a href="https://publons.com/researcher/AAS-3425-2021/"
                        class="text-white btn btn-sm btn-primary">
                        Publons Profile</a>
                        </button>
                      </div>
